...
insert into item_on_sale (id,category_id,name,description,stock,price) values ( 3,3,'Fluffy Socks','Warm extra long socks (new)', 1, 3.50);
insert into item_on_sale (id,category_id,name,description,stock,price) values ( 4,4,'Tumbler Glass','Reject tumbler glasses (new)' 5, 1.25);
insert into item_on_sale (id,category_id,name,description,stock,price) values ( 5,5,'Piano','Grand, in need of tuning',1,99.00);
insert into item_on_sale (id,category_id,name,description,stock,price) values ( 6,4,'Chair','Comfortable armchair in good cond.', 4, 15.00);
insert into item_on_sale (id,category_id,name,description,stock,price) values ( 7,1,'Washing Machine','1600rpm spin, A+++ rate', 6, 50.00);
insert into item_on_sale (id,category_id,name,description,stock,price) values ( 8,4,'Water jug','Antique cristal, 2l',2,75.00);
insert into item_on_sale (id,category_id,name,description,stock,price) values ( 9,6,'Rowing machine','Great for keeping fit',1, 25.00);
insert into item_on_sale (id,category_id,name,description,stock,price) values ( 10,6,'Junior tennis raquet','Never used',2,15);